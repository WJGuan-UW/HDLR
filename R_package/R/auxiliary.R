...
#' @name invlogit
#' @keywords internal
#' @param y The log-odds, a numeric value
#' @return The corresponding inverse logit probability at point y
#'
invlogit = function(y){
...
#' The derivative of the inverse logit function
#' @name d.invlogit
#' @keywords internal
#' @param y The log-odds, a numeric value
#' @return The derivative of inverse logit probability at point y
