...
#SBATCH --job-name=Debcf_equicor_ext    # Job name
...
R CMD BATCH --no-save --no-restore "--args runInd=${SLURM_ARRAY_TASK_ID}" Debcf_equicor.R "output/${SLURM_JOB_NAME}_${SLURM_ARRAY_TASK_ID}.Rout"