...
#SBATCH --job-name=Debcf_AR_ext         # Job name
...
R CMD BATCH --no-save --no-restore "--args runInd=${SLURM_ARRAY_TASK_ID}" Debcf_AR.R "output/${SLURM_JOB_NAME}_${SLURM_ARRAY_TASK_ID}.Rout"