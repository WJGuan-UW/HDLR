...
#' @param prob_upper The upper limit of the 95% confidence interval for the case probability.
#' @param prob_lower The lower limit of the 95% confidence interval for the case probability.
